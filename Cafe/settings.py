...
SECRET_KEY = 'django-insecure-6q0(31aa56iw5d_2s#*k((te!h72ps-s(c#zuhpjvcw(t6!4-s'
...
## Removing Authentication validation to allow simple password
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'instructor'
EMAIL_HOST_PASSWORD = 'mavericks'
